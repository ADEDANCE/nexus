    ...
    <section className=" bg-green-50 w-full py-20 px-6">
      ...
      >
        <div className=" max-w-7xl mx-auto flex flex-col items-center">
          ...
          <h1 className=" mt-3 text-black text-4xl font-bold text-center">
            Smart Farming Starts Here
          </h1>
          <p className=" mt-3 text-gray-600 text-center">
            Upload a photo of your plant. Nexus identifies diseases, explains
            the causes, and tells you exactly how to treat them.
          </p>
